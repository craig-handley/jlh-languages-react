      ...
      <section id="three" className="wrapper special">
        <div className="inner">
          <header className="align-center">
            <h2>Spanish Restaurant Experiences For Schools</h2>
          </header>
          <div className="flex flex-2">
            <article >
              ...
              <footer className="align-center">
                <a href="/schools-spanish-restaurant" className="button special">More</a>
              </footer>
            </article>
            <article>
              <header className="align-center">
              ...
              <footer className="align-center">
                <a href="/schools-spanish-mobile" className="button special">More</a>
              </footer>
            </article>
          </div>
          <br />
